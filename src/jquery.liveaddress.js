...
(function ($, window, document) {
	...
	function UI() {
		...
		var loaderWidth = 24;
		var loaderHeight = 8; // TODO: Update these if the image changes
		...
		this.showMissingSecondary = function (data) {
			...
			var html = "<div class=\"smarty-ui\" style=\"top: " + corners.top + "px; left: " + corners.left + "px;\">" +
				...
				"<input id=\"smarty-popup-secondary-number-input-box\" class=\"smarty-popup-secondary-number-input-box smarty-addr-" + addr.id() +
				"\" type=\"text\" name=\"secondarynumber\" placeholder=\"Enter number here\"><br>" +
				"<input id=\"smarty-popup-secondary-number-form-submit-button\" class=\"smarty-popup-secondary-number-form-submit-button smarty-addr-" + addr.id() +
